...
var getProfileName = __webpack_require__(1960);
...
var parseKnownFiles = __webpack_require__(2464);
...
var constants = __webpack_require__(1963);
;// ../../node_modules/.pnpm/@smithy+core@3.24.3/node_modules/@smithy/core/dist-es/submodules/config/shared-ini-file-loader/getSsoSessionData.js
...
var parseIni = __webpack_require__(1967);
...
var readFile = __webpack_require__(1968);
;// ../../node_modules/.pnpm/@smithy+core@3.24.3/node_modules/@smithy/core/dist-es/submodules/config/shared-ini-file-loader/loadSsoSessionData.js
...
;// ../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.972.42/node_modules/@aws-sdk/credential-provider-sso/dist-es/isSsoProfile.js
...
var ProviderError = __webpack_require__(1957);
;// ../../node_modules/.pnpm/@smithy+core@3.24.3/node_modules/@smithy/core/dist-es/submodules/config/property-provider/TokenProviderError.js
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@smithy+core@3.24.3/node_modules/@smithy/core/dist-es/submodules/config/shared-ini-file-loader/getSSOTokenFromFile.js
var getSSOTokenFromFile = __webpack_require__(2465);
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/constants.js
const EXPIRE_WINDOW_MS = 5 * 60 * 1000;
const REFRESH_MESSAGE = `To refresh this SSO session run 'aws sso login' with the corresponding profile.`;

;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/getSsoOidcClient.js
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await Promise.all(/* import() */[__webpack_require__.e(11), __webpack_require__.e(13)]).then(__webpack_require__.bind(__webpack_require__, 2479));
...
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/getNewSsoOidcToken.js

const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(11), __webpack_require__.e(13)]).then(__webpack_require__.bind(__webpack_require__, 2479));
...
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/validateTokenExpiry.js
...
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/validateTokenKey.js
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@smithy+core@3.24.3/node_modules/@smithy/core/dist-es/submodules/config/shared-ini-file-loader/getSSOTokenFilepath.js
var getSSOTokenFilepath = __webpack_require__(2466);
// EXTERNAL MODULE: external "node:fs"
var external_node_fs_ = __webpack_require__(797);
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/writeSSOTokenToFile.js
...
;// ../../node_modules/.pnpm/@aws-sdk+token-providers@3.1049.0/node_modules/@aws-sdk/token-providers/dist-es/fromSso.js
...
;// ../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.972.42/node_modules/@aws-sdk/credential-provider-sso/dist-es/resolveSSOCredentials.js
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.all(/* import() */[__webpack_require__.e(11), __webpack_require__.e(10)]).then(__webpack_require__.bind(__webpack_require__, 2475));
    const sso = ssoClient ||
...
;// ../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.972.42/node_modules/@aws-sdk/credential-provider-sso/dist-es/validateSsoProfile.js
...
;// ../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.972.42/node_modules/@aws-sdk/credential-provider-sso/dist-es/fromSSO.js
...
;// ../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.972.42/node_modules/@aws-sdk/credential-provider-sso/dist-es/index.js
...
/* harmony export */ });
/* harmony import */ var node_crypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1992);
...
/* harmony import */ var _getHomeDir__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1965);
...
/* harmony import */ var _getSSOTokenFilepath__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2466);
...
var loadSharedConfigFiles = __webpack_require__(1961);
